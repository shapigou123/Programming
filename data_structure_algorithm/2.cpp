...
bool Coordinate::operator==(const Coordinate &p1,const Coordinate &p1)
{
	return
		 (p1.m_iX == p2.m_iX)
		 &&
...
istream& operator>>(iostream &input, const Coordinate &p)
{
	input>>Coordinate.m_iX >>Coordinate.m_iY;
	return input;
}
