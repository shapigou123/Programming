...
public:
    IndexMaxHeap(int capacity){
		...
		//reverse[i]表示i这个索引在堆（indexes数组）中的位置
        reverse = new int[capacity+1];
		//当堆中一个元素都没有，i这个索引对应的索引指向0
	...
	//防止数组越界，要保证i这个索引存在于堆中。
	//不能仅仅说i>=1 && i<=capacity就说是合法的i
	//因为函数的功能是将i这个索引的元素修改为newItem
	//我们就要保证i这个索引的元素真的存在于堆中
	//i在容量范围里并不意味着它在堆中
